...
const lineas=[
    //{texto: 'Municipios', imagen:'./static/img/municipios.png', nombreSource:'Municipios', nombreCapa: 'Municipios-layer', nombreJson: './static/datos/MunicipioCYL.geojson', color:'#555', mostrar: 'visible', grosor: 0.5, checked:true}
];
const rellenos=[
...
const criteriosNombre=["CF", "Variacion", "Viento", "LCOE",  "Distancia", "Emisiones Evitadas", "Comunidades Energeticas"];
const criteriosId=["CF", "Variacion", "Viento", "LCOE", "Distancia", "EmisionesEvitadas",  "NumMasasAgua"];
const criteriosValue=[0.15,0.15,0.14,0.14,0.14,0.14,0.14,0.14];
